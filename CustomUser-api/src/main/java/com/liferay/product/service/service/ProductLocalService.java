...
public interface ProductLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProductLocalServiceUtil} to access the product local service. Add custom service methods to {@link com.liferay.product.service.service.impl.ProductLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Product fetchProductByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Product getProductByUuidAndCompanyId(java.lang.String uuid,
